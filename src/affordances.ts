...
export interface DiataxisHeader {
  ...
  id: string | null;
  /** OKF §7 producer actor, e.g. "ktl-registrar/1.5.0". */
  generatedBy: string;
...
const DIATAXIS_DESCRIPTION =
  "Map of Content that groups this bundle's concepts by Diátaxis genre. Generated by KTL Registrar from each concept's genre field; regenerate it rather than editing it by hand.";
 ...
 *  wrote (recognised by its own `ktl-registrar/` actor - a human-authored `generated`
 *  block is never touched). Returns null when there is nothing to
 *  refresh. */
